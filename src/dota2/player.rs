...
impl From<crate::dota2::get_match_history_by_seq_num::Player> for Player {
    fn from(value: crate::dota2::get_match_history_by_seq_num::Player) -> Self {
        Self {
            ...
            item_0: Item::from(value.item_0).into_option(),
            item_1: Item::from(value.item_1).into_option(),
            item_2: Item::from(value.item_2).into_option(),
            item_3: Item::from(value.item_3).into_option(),
            item_4: Item::from(value.item_4).into_option(),
            item_5: Item::from(value.item_5).into_option(),
            backpack_0: Item::from(value.backpack_0).into_option(),
            backpack_1: Item::from(value.backpack_1).into_option(),
            backpack_2: Item::from(value.backpack_2).into_option(),
            item_neutral: Item::from(value.item_neutral).into_option(),
            kills: value.kills,
            deaths: value.deaths,
