...
define_dota2_enum! {
    ...
    pub enum Item: u16 {
        ...
        RecipeGungir = 1565,
        OrbOfFrost = 1575,
        EnhancementVast = 1576,
        EnhancementQuickened = 1577,
        CursedCirclet = 1578,
        OgreHeart = 1579,
        NeutralTabi = 1580,
        EnhancementAudacious = 1581,
        HellbearTotem = 1582,
        EnhancementMystical = 1583,
        EnhancementAlert = 1584,
        EnhancementBrawny = 1585,
        EnhancementTough = 1586,
        EnhancementFeverish = 1587,
        EnhancementFleetfooted = 1588,
        EnhancementCrude = 1589,
        EnhancementBoundless = 1590,
        EnhancementWise = 1591,
        EnhancementTimeless = 1592,
        EnhancementGreedy = 1593,
        EnhancementVampiric = 1594,
        EnhancementKeenEyed = 1595,
        EnhancementEvolved = 1596,
        EnhancementTitanic = 1597,
        UnrelentingEye = 1598,
        ManaDraught = 1599,
        RippersLash = 1600,
        CripplingCrossbow = 1601,
        GaleGuard = 1602,
        GunpowderGauntlets = 1603,
        SearingSignet = 1604,
        SerratedShiv = 1605,
        PolliwogCharm = 1606,
        MagnifyingMonocle = 1607,
        PyrrhicCloak = 1608,
        MadstoneBundle = 1609,
        MinibossMinionSummoner = 1610,
